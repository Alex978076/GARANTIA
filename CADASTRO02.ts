...
const alunos: Aluno[] = [
       { nome: "Carlos Eduardo", nota1: 8.0, nota2: 6.5, turma: "2A" },
          { nome: "Fernanda Lima", nota1: 5.0, nota2: 4.5, turma: "2B" },
       { nome: "Rafael Souza", nota1: 9.0, nota2: 8.5, turma: "2A" },
   { nome: "Tatiane Moura", nota1: 6.0, nota2: 7.0, turma: "2C" },
        { nome: "Lucas Pereira", nota1: 3.5, nota2: 5.0, turma: "2B" },
]
